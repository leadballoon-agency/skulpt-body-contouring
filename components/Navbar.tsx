  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 py-4 transition-all duration-500 ${
        ...
        isScrolled
          ? 'bg-white bg-opacity-90 backdrop-blur-lg shadow-lg border-b border-[#967e15] border-opacity-20'
          : ''
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <a
            ...
            className="px-6 py-2.5 bg-[#967e15] text-white font-semibold rounded-full hover:bg-[#b59518] transition-all transform hover:scale-105 shadow-lg flex items-center gap-2"
          >
