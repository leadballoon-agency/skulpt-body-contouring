...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setIsScrolled(currentScroll > 50) // Add glassmorphism after slight scroll
    }
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 py-4 transition-all duration-500 ${
        ...
        isScrolled
          ? 'bg-white bg-opacity-80 backdrop-blur-lg shadow-lg border-b border-gray-200 border-opacity-30'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <a
            ...
            className="px-6 py-2.5 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-full hover:from-green-600 hover:to-green-700 transition-all transform hover:scale-105 shadow-lg flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
            </svg>
            <span className="hidden sm:inline">Call Now</span>
            <span className="text-sm">07700 173390</span>
          </a>
        </div>
